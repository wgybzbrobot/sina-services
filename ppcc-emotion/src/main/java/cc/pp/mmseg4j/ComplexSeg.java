package cc.pp.mmseg4j;

import java.util.ArrayList;
import java.util.List;

import cc.pp.mmseg4j.rule.LargestAvgLenRule;
import cc.pp.mmseg4j.rule.LargestSumDegreeFreedomRule;
import cc.pp.mmseg4j.rule.MaxMatchRule;
import cc.pp.mmseg4j.rule.Rule;
import cc.pp.mmseg4j.rule.SmallestVarianceRule;

import cc.pp.mmseg4j.CharNode;
import cc.pp.mmseg4j.Chunk;
import cc.pp.mmseg4j.ComplexSeg;
import cc.pp.mmseg4j.Dictionary;
import cc.pp.mmseg4j.Seg;
import cc.pp.mmseg4j.Sentence;
import cc.pp.mmseg4j.Word;
