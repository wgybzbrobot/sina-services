...
public class FansAnalysisResult {
	...
	// 5、粉丝的热门标签
	private List<HashMap<String, String>> hotTags = new ArrayList<>();
	// 6、粉丝等级分布（按粉丝量）
	...
	public List<HashMap<String, String>> getHotTags() {
		return hotTags;
	}

	public void setHotTags(List<HashMap<String, String>> hotTags) {
