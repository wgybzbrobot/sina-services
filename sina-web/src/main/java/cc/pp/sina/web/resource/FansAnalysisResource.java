...
public class FansAnalysisResource extends ServerResource {
	...
	private static Logger logger = LoggerFactory.getLogger(FansAnalysisResource.class);
	...
	public Representation getFansUids() {
		...
		ComputeInfoApplication application = (ComputeInfoApplication) getApplication();
		return new StringRepresentation(application.getFansAnalysisResult(uid));
	}
