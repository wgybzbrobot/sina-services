...
import cc.pp.sina.bozhus.single.weibo.SWeiboUtils;
import cc.pp.sina.bozhus.single.weibo.SimpleWeiboResult;
...
public class T2SingleWeiboAnalysis {
	...
	public T2SingleWeiboAnalysis(SinaWeiboInfoDao sinaWeiboInfoDao) {
	...
	public static void main(String[] args) {
		...
		T2SingleWeiboAnalysis simpleWeiboAnalysis = new T2SingleWeiboAnalysis(sinaWeiboInfoDao);
	...
	public void insertSingleWeiboResult() {
		...
		for (String wid : wids) {
			...
			if (result != null) {
				try {
					singleWeibo.updateSingleWeibo("sina", Long.parseLong(wid), "",
