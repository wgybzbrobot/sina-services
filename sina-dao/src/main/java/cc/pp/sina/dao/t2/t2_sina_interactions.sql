...
--
-- Host: localhost
-- Generation Time: 2014-03-12 13:31:37
...
--
-- 表的结构 `t2_sina_interactions`
--

CREATE TABLE IF NOT EXISTS `t2_sina_interactions` (
  `id` int(10) NOT NULL AUTO_INCREMENT COMMENT '自增id',
  `username` bigint(20) NOT NULL COMMENT '用户名',
  `date` int(11) unsigned NOT NULL COMMENT '纪录日期',
  `fanscount` int(10) unsigned NOT NULL COMMENT '粉丝数',
  `allcount` int(10) unsigned NOT NULL COMMENT '交互数据',
