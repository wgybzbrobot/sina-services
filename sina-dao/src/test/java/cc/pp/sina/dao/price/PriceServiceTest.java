...
public class PriceServiceTest {
    ...
    public void testGetPrices() throws Exception {
        Collection<PriceSource> prices = priceService.getSourcePrices(bozhuPrice);
    ...
    public void testSourceCRUD() {
        ...
        assertTrue(priceService.getSourcePrices(bozhuPrice).isEmpty());
        ...
        assertEquals(expectedList, priceService.getSourcePrices(bozhuPrice));
        ...
        Collection<PriceSource> result = priceService.getSourcePrices(bozhuPrice);
        ...
        result = priceService.getSourcePrices(bozhuPrice);
        assertEquals(3, result.size());
        ...
        assertEquals(0, priceService.getSourcePrices(bozhuPrice).size());
    }
